...
isBasedOn: https://www.nigella.com/recipes/crab-mac-n-cheese
...
- items:
  ...
  - quantity: 2
    unit: tbsp
    item: "(approx. 15g) freshly grated Parmesan"
  - quantity: 1.5
    unit: tbsp
    item: "(15g) plain flour"
  - quantity: 0.25
    unit: tsp
    item: ground mace
  - quantity: 0.25
  ...
  - quantity: 0.125
    unit: tsp
    item: Aleppo pepper, or hot smoked paprika, plus more to sprinkle at the end
  - quantity: 250
    unit: ml
    item: full-fat milk
  - quantity: 1
  ...
  - quantity: 1
    item: fat clove of garlic
  - quantity: 0.5
    unit: tsp
    item: Worcestershire sauce
  - quantity: 200
    unit: g
    item: conchiglie rigate pasta
  - quantity: 100
    unit: g
    item: mixed white and brown crabmeat (50/50)
    optional: true
