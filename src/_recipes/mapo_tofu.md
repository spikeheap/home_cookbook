...
isBasedOn: https://www.chinasichuanfood.com/mapo-tofu-recipe/
...
- items:
  - quantity: 450
    unit: g
    item: soft tofu, cut into 2cm cubes
  - quantity: 100
    unit: g
    item: minced beef or pork
  - quantity: 0.5
    unit: tsp
    item: salt
  - item: white pepper
  - quantity: 3
    unit: tbsp
    item: cooking oil (divided)
  - quantity: 1.5
    unit: tbsp
    item: doubanjiang, roughly chopped
  - quantity: 0.5
    unit: tbsp
  ...
  - quantity: 2
    item: scallion whites, finely chopped
  - quantity: 400
    unit: ml
    item: water or broth
  - quantity: 1
