...
author:
  "@type": Person
  name: Mary Berry
image: https://food-images.files.bbci.co.uk/food/recipes/drop_scones_38257_16x9.jpg
prepTime: PT30M
cookTime: PT30M
...
recipeInstructions:
- items:
  - 'Place the flour, baking powder, sugar and orange zest in a mixing bowl. Make
    a well in the centre and then add the egg and half of the milk. Beat well with
    a whisk until you have a smooth, thick batter. Beat in enough of the milk to make
    a batter the consistency of thick pouring cream – you may not need all the milk. '
  - 'Heat a large non-stick frying pan and grease with a little oil. Drop the mixture
    in dessertspoonfuls onto the hot pan, spacing the mixture well apart to allow
    for them to spread. When bubbles appear on the surface, turn the scones over with
    a palette knife or spatula and cook on the other side for a further 30 seconds
    to 1 minute, or until they are lightly golden brown. '
